...
> = core.schemas.object({
  paymentMethodData: core.schemas.lazyObject(() => schemas.payments.PayPalBillingAgreementAPISchema),
...
export declare namespace PayPalBillingAgreementSchema {
  interface Raw {
    paymentMethodData: schemas.payments.PayPalBillingAgreementAPISchema.Raw;
