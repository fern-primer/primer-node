...
export interface Request {
  ...
  _body: PrimerApi.payments.CapturePaymentRequest;
}

export type Response = core.APIResponse<PrimerApi.payments.PaymentResponse, PrimerApi.payments.capture.Error>;
